...
from mtl_pytorch.layer_node import Sequential, Conv2dNode, BN2dNode
...
class MobileNetV2(mtl_model):
    def __init__(self, n_class=10, width_mult=1., heads_dict={}):
        ...
        self.features = [conv_bn(3, input_channel, 1, task_list=self.task_list)]
